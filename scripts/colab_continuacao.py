...
#
# RECURSOS:
#   - Totalmente auto-contida (imune a cache de módulos do Python)
...
#   - Logs a cada batch com ETA, velocidade e acurácia por modalidade
...
if len(checkpoints) == 0:
    ...
    # Fallback de imagens do HuggingFace se necessário
    need_hf = False
    for r in records[:50]:
